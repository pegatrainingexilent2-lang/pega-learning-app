...
export function AppSidebar({ initialTopics }: AppSidebarProps) {
    ...
    return (
        <aside className="w-80 h-screen flex flex-col border-r border-indigo-100/50 backdrop-blur-xl shrink-0 relative overflow-hidden sidebar-bg">
            {/* Clean gradient background */}
            <div className="absolute inset-0 bg-gradient-to-b from-indigo-50/80 via-white/60 to-purple-50/70" />
            
            {/* Subtle accent gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-100/40 via-transparent to-purple-100/30" />
            
            {/* Very subtle pattern */}
            <div className="absolute inset-0 opacity-[0.15] sidebar-pattern" />
